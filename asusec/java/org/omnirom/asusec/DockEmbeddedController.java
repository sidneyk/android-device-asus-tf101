...
public final class DockEmbeddedController {
    private static final String TAG = "AsusecDockEmbeddedController";

    private static int ASUSEC_EC_ON = 1;
    private static int ASUSEC_EC_OFF = 0;
    ...
    private void readECWakeUpStatus() {
        boolean ecWakeUp = nativeReadECWakeUp() == ASUSEC_EC_ON;
        mECWakeUp = ecWakeUp;
